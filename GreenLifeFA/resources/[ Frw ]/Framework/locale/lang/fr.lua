Locales['fr'] = {
	...
	['gave_item'] = 'vous avez donné ~g~%sx~s~ ~r~%s~s~ à ~g~%s~s~',
	['received_item'] = 'vous avez reçu ~g~%sx~s~ ~r~%s~s~ par ~g~%s~s~',
	['gave_weapon'] = 'vous avez donné ~g~1x~s~ ~r~%s~s~ à ~g~%s~s~',
	['gave_weapon_ammo'] = 'vous avez donné ~g~%sx~s~ balles pour ~g~%s~s~ à ~g~%s~s~',
	['gave_weapon_withammo'] = 'vous avez donné ~g~1x~s~ ~r~%s~s~ avec ~g~%sx~s~ balles à ~g~%s~s~',
	['gave_weapon_hasalready'] = '~g~%s~s~ a déjà ~g~%s~s~',
	['gave_weapon_noweapon'] = '~g~%s~s~ n\'a pas cette arme',
	['received_weapon'] = 'vous recevez ~g~1x~s~ ~g~%s~s~ de ~g~%s~s~',
	['received_weapon_ammo'] = 'vous avez reçu ~g~%sx~s~ balles pour votre ~g~%s~s~ de ~g~%s~s~',
	['received_weapon_withammo'] = 'vous avez reçu ~g~1x~s~ ~g~%s~s~ avec ~g~%sx~s~ balles de ~g~%s~s~',
	['received_weapon_hasalready'] = '~g~%s~s~ a tenté de vous donner ~g~%s~s~, mais vous en aviez déjà un exemplaire',
	['received_weapon_noweapon'] = '~g~%s~s~ tente de vous donner des munitions pour ~g~%s~s~, mais vous n\'en avez pas',
	['gave_money'] = 'vous avez donné ~g~$%s~s~ à ~g~%s~s~',
	['received_money'] = 'vous avez reçu ~g~$%s~s~ par ~g~%s~s~',
	['gave_account_money'] = 'vous avez donné ~g~$%s~s~ (%s) à ~g~%s~s~',
	['received_account_money'] = 'vous avez reçu ~g~$%s~s~ (%s) par ~g~%s~s~',
	['amount_invalid'] = 'montant invalide',
	['players_nearby'] = 'aucun joueur à proximité',
	['ex_inv_lim'] = 'action impossible, depassement de la limite d\'inventaire pour ~g~%s~s~',
	['imp_invalid_quantity'] = 'action impossible, ~r~quantité invalide',
	['imp_invalid_amount'] = 'action impossible, ~r~montant invalide',
	['threw_standard'] = 'vous avez jeté ~g~%sx~s~ ~g~%s~s~',
	['threw_money'] = 'vous avez jeté ~g~$%s~s~ ~g~cash~s~',
	['threw_account'] = 'vous avez jeté ~g~$%s~s~ ~g~%s~s~',
	['threw_weapon'] = 'vous avez jeté ~g~1x~s~ ~g~%s~s~',
	['threw_weapon_ammo'] = 'vous avez jeté ~g~1x~s~ ~g~%s~s~ avec ~g~%sx~s~ balles',
	['threw_weapon_already'] = 'you already carry the same weapon',
	['threw_cannot_pickup'] = 'vous ne pouvez ramasser ceci, inventaire plein !',
	['threw_pickup_prompt'] = 'appuyer sur ~g~E~s~ pour ramasser',
	...
	['weapon_lucile'] = 'Lucile',
	['weapon_bayonet'] = 'Bayonette',
	...
	['component_scope'] = 'Viseur portée montée',
