...
function ESX.RegisterUsableItem(item, cb)
	...
	exports['GreenLifeHud']:createUsableItem(item, cb)
end
...
function ESX.SpawnVehicle(model, position, heading, plate, locked, xPlayer, owner, callback)
	exports["GreenLifeHud"]:SpawnVehicle(model, position, heading, plate, locked, xPlayer, owner, callback)
end

---@param vehiclePlate string
---@param callback function
function ESX.RemoveVehicle(vehiclePlate, callback)
	exports["GreenLifeHud"]:RemoveVehicle(vehiclePlate, callback)
end
...
function ESX.GiveCarKey(xPlayer, numberPlate, notify)
	-- exports["Abteww"]:GiveCarKey(xPlayer, numberPlate, notify);
end

---@param societyName string
---@return boolean
function ESX.DoesSocietyExist(societyName)
	return exports["GreenLifeHud"]:SocietyExist(societyName);
end

---@param societyName string
---@return number
function ESX.GetSocietyMoney(societyName)
	return exports["GreenLifeHud"]:GetSocietyMoney(societyName);
end

---@param societyName string
---@param amount number
function ESX.AddSocietyMoney(societyName, amount)
	exports["GreenLifeHud"]:AddSocietyMoney(societyName, amount);
end

---@param societyName string
---@param amount number
function ESX.RemoveSocietyMoney(societyName, amount)
	exports["GreenLifeHud"]:RemoveSocietyMoney(societyName, amount);
end
...
function ESX.AddSociety(name, label, canWashMoney, canUseOffshore, societyType, callback)
	-- exports["Abteww"]:AddSociety(name, label, canWashMoney, canUseOffshore, societyType, callback);
end
