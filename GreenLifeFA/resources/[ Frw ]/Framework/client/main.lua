...
AddEventHandler("Abteww:GreenLife:pvpModeUpdated", function(inPVP)
    IsInPVP = inPVP;
end);
...
RegisterNetEvent("Abteww:CanFight", function(canFight)
...
CreateThread(function()
	...
	if playerPed and playerPed ~= -1 then
		while GetResourceState('GreenLife') ~= 'started' do
			Wait(10)
		end
