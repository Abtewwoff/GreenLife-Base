...
DevToolMenu = RageUI.CreateMenu("", "Outils de développement")
CoordsMenu = RageUI.CreateSubMenu(DevToolMenu, "", "Coordonées")
DrawMarkerMenu = RageUI.CreateSubMenu(DevToolMenu, "", "Draw Marker")
DrawRectMenu = RageUI.CreateSubMenu(DevToolMenu, "", "Draw Rect")
PropsMenu = RageUI.CreateSubMenu(DevToolMenu, "", "Props")
PropsListMenu = RageUI.CreateSubMenu(PropsMenu, "", "Props")
        ...
        Citizen.CreateThread(function ()
            while open do 
                RageUI.IsVisible(DevToolMenu, function()
                    RageUI.Button("Coordonées", false , {RightBadge = RageUI.BadgeStyle.Star}, true , {}, CoordsMenu)
                    RageUI.Button("Draw Marker", false , {RightBadge = RageUI.BadgeStyle.Star}, true , {}, DrawMarkerMenu)
                    RageUI.Button("TP Marker", false , {RightBadge = RageUI.BadgeStyle.Star}, true , {
                        onSelected = function()
                            TeleportBlips()
                        end
                    })
                ...
                RageUI.IsVisible(CoordsMenu, function()
                    ...
                    RageUI.Button("Update les perfs", nil, {RightLabel = "→→"}, true, {
                        onSelected = function()
                            local veh = GetVehiclePedIsIn(PlayerPedId(), false)  -- Ensure 'veh' is the current vehicle
                            if veh and veh ~= 0 then  -- Check if the player is in a vehicle
                                ...
                                ESX.ShowNotification("~r~Vous devez être dans un véhicule pour faire ça.")
                            end
                        end
                    })
                ...
                RageUI.IsVisible(DrawMarkerMenu, function()
                    ...
                    RageUI.Separator("Couleur du Marker: R: ~r~"..RColor.." ~s~G: ~g~"..GColor.." ~s~B: ~g~"..BColor)
                ...
                RageUI.IsVisible(DrawRectMenu, function()
                    ...
                    RageUI.Separator("Couleur du Draw Rect: R: ~r~"..RectRcolor.." ~s~G: ~g~"..RectGcolor.." ~s~B: ~g~"..RectBcolor)
                ...
                RageUI.IsVisible(PropsMenu, function()
                    RageUI.Button("Get closest props", "Retourne le ~g~hash~s~ du props se trouvant le plus proche de vous" , {RightLabel = "→→"}, true , {
                        onSelected = function() 
                            SendNUIMessage({
                ...
                RageUI.IsVisible(PropsListMenu, function()
                    ...
                    Visual.Subtitle("Appuyez sur [~g~+~s~] / [~g~-~s~] pour Zoom / Dézoom", 1000)
...
Keys.Register('F11','F11', '', function()
