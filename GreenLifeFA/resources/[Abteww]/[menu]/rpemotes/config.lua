Config = {
    ...
    Framework = 'Framework', -- Used for few framework-dependent things. Accepted values: 'qb-core', false
    ...
    MenuPosition = 'left', -- You can change the menu position here. Use 'left' or 'right'
