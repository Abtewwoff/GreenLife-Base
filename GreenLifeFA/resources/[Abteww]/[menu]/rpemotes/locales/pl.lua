Locales['pl'] = {
 -- Polish 🇵🇱
        ['emotes'] = "~h~~g~ Animacje 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Tańce",
        ['animalemotes'] = "~h~~g~ 🐩 Animacje zwierząt",
        ['propemotes'] = "~h~~g~ 📦 Animacje z propami",
        ...
        ['walkingstyles'] = "~h~~g~ Style chodzenia 🚶🏻‍♂️",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Współdzielone animacje",
        ['shareemotesinfo'] = "Zaproś pobliską osobę do wspólnej animacji",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Współdzielone tańce",
