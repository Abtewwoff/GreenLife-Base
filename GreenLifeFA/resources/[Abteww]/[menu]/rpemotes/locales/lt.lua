Locales['lt'] = {
 -- Lithuanian (LT)
        ['emotes'] = '~h~~g~ Animacijos 🎬',
        ['danceemotes'] = "~h~~g~ 🕺 Sokiu animacijos",
        ['animalemotes'] = "~h~~g~ 🐩 Gyvunu animacijos",
        ['propemotes'] = "~h~~g~ 📦 Daiktu animacijos",
        ...
        ['walkingstyles'] = "~h~~g~ Ejimo stiliai 🚶🏻‍♂️",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Porines animacijos",
        ['shareemotesinfo'] = "Pakvieskite salia esanti zmogu animacijai kartu",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Poriniai sokiai",
