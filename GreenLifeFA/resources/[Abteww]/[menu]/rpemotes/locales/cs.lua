Locales['cs'] = {
 -- Czech 🇨🇿
        ['emotes'] = "~h~~g~ Animace 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Taneční Animace",
        ['animalemotes'] = "~h~~g~ 🐩 Zvířecí Animace",
        ['propemotes'] = "~h~~g~ 📦 Animace s předměty",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Sdílené animace",
        ['shareemotesinfo'] = "Pozvěte osobu v okolí, k tanci",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Sdílené tance",
