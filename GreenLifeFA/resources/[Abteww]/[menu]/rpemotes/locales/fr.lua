Locales['fr'] = {
        -- French 🇫🇷
               ['emotes'] = "~g~ Emotes 🎬",
               ['danceemotes'] = "~g~ 🕺 Danses",
               ['animalemotes'] = "~g~ 🐩 Emotes d'animaux",
               ['propemotes'] = "~g~ 📦 Emotes objet",
               ['favoriteemotes'] = "~y~ 🌟 Favoris",
               ...
               ['walkingstyles'] = "~g~ Styles de marche 🚶🏻‍♂️",
               ['resetdef'] = "Réinitialiser aux valeurs par défaut",
               ['normalreset'] = "~r~ Normal (réinitialiser)",
               ['moods'] = "~g~ Humeurs 😒",
               ['infoupdate'] = "Crédits 🤝🏻",
