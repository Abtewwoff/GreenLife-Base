Locales['pt'] = {
 -- Brazilian Portuguese 🇧🇷
        ['emotes'] = "~h~~g~ Emotes 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Emotes de Danças",
        ['animalemotes'] = "~h~~g~ 🐩 Emotes de Animais",
        ['propemotes'] = "~h~~g~ 📦 Emotes com Props",
        ...
        ['walkingstyles'] = "~h~~g~ Estilos de Caminhada 🚶🏻‍♂️",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Emotes compartilhados",
        ['shareemotesinfo'] = "Convide uma pessoa próxima para realizar a animação",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Danças compartilhadas",
