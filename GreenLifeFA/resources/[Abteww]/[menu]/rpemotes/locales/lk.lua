Locales['lk'] = {
 -- Sinhala 🇱🇰
        ['emotes'] = "~h~~g~ Emotes 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Natana Emotes",
        ['animalemotes'] = "~h~~g~ 🐩 Sattunge Emotes",
        ...
        ['walkingstyles'] = "~h~~g~ Awidina Styles 🚶🏻‍♂️",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Shared Emotes",
        ['shareemotesinfo'] = "Laga inna kenata emote eka danna katha krnna",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Shared Natana Emotes",
