Locales['hu'] = {
 -- Hungarian 🇭🇺
        ['emotes'] = "~h~~g~ Animációs Menü 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Tánc Animációk",
        ['animalemotes'] = "~h~~g~ 🐩 Állatos Animációk",
        ['propemotes'] = "~h~~g~ 📦 Tárgyas Animációk",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Megosztott animációk",
        ['shareemotesinfo'] = "Hívj meg egy közeli személyt animációra",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Közös Táncok",
