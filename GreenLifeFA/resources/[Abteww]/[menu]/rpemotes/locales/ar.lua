Locales['ar'] = {
 -- Arabic
        ['emotes'] = " ~h~~g~حركات 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 حركات الرقص",
        ['animalemotes'] = "~h~~g~ 🐩 حركات الحيوانات",
        ['propemotes'] = "~h~~g~ 📦  حركات الاوبجكتات",
        ...
        ['walkingstyles'] = "~h~~g~ اساليب المشي 🚶🏻‍",
        ...
        ['shareemotes'] = "~h~~g~ 👫 الحركات المشتركة",
        ['shareemotesinfo'] = "دعوة شخص قريب لعمل حركات معه",
        ['sharedanceemotes'] = "~h~~g~ 🕺 الرقصات المشتركة",
