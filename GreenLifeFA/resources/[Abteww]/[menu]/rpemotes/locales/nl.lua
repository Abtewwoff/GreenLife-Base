Locales['nl'] = {
 -- Dutch 🇳🇱
        ['emotes'] = "~h~~g~ Animaties 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Dans Animaties",
        ['animalemotes'] = "~h~~g~ 🐩 Dier Animaties",
        ['propemotes'] = "~h~~g~ 📦 Prop Animaties",
        ...
        ['sharedanceemotes'] = "~h~~g~ 🕺 Gedeelde Dansjes",
