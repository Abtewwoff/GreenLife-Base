Locales['el'] = {
 -- Greek 🇬🇷
        ['emotes'] = '~h~~g~ Κινήσεις 🎬',
        ['danceemotes'] = "~h~~g~ 🕺 Χοροί",
        ['animalemotes'] = "~h~~g~ 🐩 Ζώα",
        ['propemotes'] = "~h~~g~ 📦 Αντικείμενα",
        ...
        ['walkingstyles'] = "~h~~g~ Είδη Περπατήματος 🚶🏻‍♂️",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Κινήσεις Με Άλλους Παίκτες",
        ['shareemotesinfo'] = "Προσκάλεσε τον κοντινότερο παίκτη για να κάνετε μια κίνηση",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Χοροί Με Άλλους Παίκτες",
