Locales['da'] = {
 -- Danish 🇩🇰
        ['emotes'] = "~h~~g~ Animationer",
        ['danceemotes'] = "~h~~g~ 🕺 Danse Animationer",
        ['animalemotes'] = "~h~~g~ 🐩 Dyr Animationer",
        ['propemotes'] = "~h~~g~ 📦 Rekvisit Animationer",
        ...
        ['sharedanceemotes'] = "~h~~g~ 🕺 Delete Danse",
