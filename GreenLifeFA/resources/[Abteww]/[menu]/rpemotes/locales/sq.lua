Locales['sq'] = {
 -- Albanian
		['emotes'] = "~h~~g~ Emotet 🎬",
		['danceemotes'] = "~h~~g~ 🕺 Emotet e Kërcimit",
		['animalemotes'] = "~h~~g~ 🐩 Emotet e Kafshëve",
		['propemotes'] = "~h~~g~ 📦 Emotet e Përparave",
		...
		['walkingstyles'] = "~h~~g~ Stilet e ecjes 🚶🏻‍♂️",
		...
		['shareemotes'] = "~h~~g~ 👫 Emotet e Ndara",
		['shareemotesinfo'] = "Ftoj një person të afërt për të emotuar",
		['sharedanceemotes'] = "~h~~g~ 🕺 Kërcime të Ndara",
