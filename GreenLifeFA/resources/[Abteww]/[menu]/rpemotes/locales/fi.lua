Locales['fi'] = {
 -- Finnish 🇫🇮
        ['emotes'] = "~h~~g~ Animaatiot 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Tanssi Animaatiot",
        ['animalemotes'] = "~h~~g~ 🐩 Eläin Animaatiot",
        ['propemotes'] = "~h~~g~ 📦 Esine Animaatiot",
        ['favoriteemotes'] = "~h~~g~ 🌟 Suosikit",
        ...
        ['walkingstyles'] = "~h~~g~ Kävelytyylit 🚶🏻‍♂️",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Yhteiset Animaatiot",
        ['shareemotesinfo'] = "Kutsu lähin pelaaja animaatioon ",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Yhteiset Tanssit",
