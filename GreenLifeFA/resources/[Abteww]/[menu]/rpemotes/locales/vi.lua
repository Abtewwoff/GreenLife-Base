Locales['vi'] = {
 -- Tiếng việt
        ['emotes'] = "~h~~g~ Hành động 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Nhảy nhót",
        ['animalemotes'] = "~h~~g~ 🐩 Thú cưng",
        ['propemotes'] = "~h~~g~ 📦 Đồ vật",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Hành động chung",
        ['shareemotesinfo'] = "Mời người ở gần tham gia hành động.",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Nhảy nhót chung",
