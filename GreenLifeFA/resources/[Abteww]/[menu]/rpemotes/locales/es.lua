Locales['es'] = {
 -- Spanish 🇪🇸
        ['emotes'] = "~h~~g~ Animaciones 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Bailes",
        ['animalemotes'] = "~h~~g~ 🐩 Emotes de animales",
        ['propemotes'] = "~h~~g~ 📦 Objetos",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Animaciones compartidas",
        ['shareemotesinfo'] = "Invita a una persona cercana para la animación.",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Bailes compartidos",
