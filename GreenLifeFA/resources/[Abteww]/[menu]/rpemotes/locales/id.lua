Locales['id'] = {
 -- Indonesian 🇮🇩
        ['emotes'] = " ~h~~g~ Emote 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Emote Menari",
        ['animalemotes'] = "~h~~g~ 🐩 Emote Hewan",
        ...
        ['walkingstyles'] = "~h~~g~ Gaya Berjalan 🚶🏻‍♂️",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Emote Bersama",
        ['shareemotesinfo'] = "Undang orang terdekat untuk beremote",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Tarian Bersama",
