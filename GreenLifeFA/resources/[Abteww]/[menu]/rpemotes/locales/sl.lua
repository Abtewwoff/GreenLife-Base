Locales['sl'] = {
 -- Slovenia
		['emotes'] = '~h~~g~ Emote 🎬',
		['danceemotes'] = "~h~~g~ 🕺 Plesi",
		['animalemotes'] = "~h~~g~ 🐩 Emote živali",
		['propemotes'] = "~h~~g~ 📦 Emote pripomočkov",
		...
		['walkingstyles'] = "~h~~g~ Sprehajalni stili 🚶🏻‍♂️",
		...
		['shareemotes'] = "~h~~g~ 👫 Deljeni Emotes",
		['shareemotesinfo'] = "Povabite osebo v bližini, da naredi emote",
		['sharedanceemotes'] = "~h~~g~ 🕺 Deljeni Plesi",
