Locales['it'] = {
 -- Italian 🇮🇹
        ['emotes'] = " ~h~~g~ Animazioni 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Animazioni Di Danza",
        ['animalemotes'] = "~h~~g~ 🐩 Animazioni Di Animali",
        ['propemotes'] = "~h~~g~ 📦 Animazioni Prop",
        ...
        ['walkingstyles'] = "~h~~g~ Stili di camminata 🚶🏻‍♂️",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Animazioni di coppia",
        ['shareemotesinfo'] = "Invita un giocatore vicino ad un'animazione",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Balli di coppia",
