Locales['no'] = {
 -- Norwegian 🇳🇴
        ['emotes'] = " ~h~~g~Animasjoner 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Danse Animasjoner",
        ['animalemotes'] = "~h~~g~ 🐩 Dyreanimasjoner",
        ['propemotes'] = "~h~~g~ 📦 Rekvisitt Animasjoner",
