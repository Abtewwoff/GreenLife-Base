Locales['de'] = {
 -- German 🇩🇪
        ['emotes'] = "~h~~g~ Emotes 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Tanz-Emotes",
        ['animalemotes'] = "~h~~g~ 🐩 Tier Emotes",
        ['propemotes'] = "~h~~g~ 📦 Prop-Emotes",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Geteilte Emotes",
        ['shareemotesinfo'] = "Laden Sie eine Person in Ihrer Nähe zum Emoten ein",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Geteilte Tänze",
