Locales['ru'] = {
 -- Russian 🇷🇺
        ['emotes'] = "~h~~g~ Эмоции 🎬",
        ['danceemotes'] = "~h~~g~ 🕺 Танцевальные эмоции",
        ['animalemotes'] = "~h~~g~ 🐩 Эмоции животных",
        ['propemotes'] = "~h~~g~ 📦 Эмоции с пропом",
        ...
        ['shareemotes'] = "~h~~g~ 👫 Совместные эмоции",
        ['shareemotesinfo'] = "Пригласите человека рядом для воспроизведения эмоции",
        ['sharedanceemotes'] = "~h~~g~ 🕺 Совместные танцы",
