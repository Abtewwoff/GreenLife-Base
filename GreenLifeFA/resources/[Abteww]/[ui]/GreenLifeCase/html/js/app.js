...
$(document).on("click", ".openinOpenCaseButton", function () {
    ...
    $.post(
        "https://GreenLifeCase/caseOpenSelect",
        JSON.stringify({
...
$(document).on("click", "#collectButton", function () {
    ...
    collectedSound.play();
    $.post(
        "https://GreenLifeCase/collectItem",
        JSON.stringify({
...
$(document).on("keydown", function () {
    switch (event.keyCode) {
        case 27: // ESC
            if (escUsable) {
                $.post("https://GreenLifeCase/closeMenu", JSON.stringify());
                $(".fullBackGround").hide();
                $(".generalSection").hide();
                $(".caseOpeningSection").hide();
                $(".topBar").hide();
