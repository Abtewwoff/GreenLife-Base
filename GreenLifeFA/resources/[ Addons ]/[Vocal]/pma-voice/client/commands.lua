...
function setProximityState(proximityRange, isCustom)
	...
	TriggerEvent('GreenLife:Hud:SetHudMicState', isCustom and #Cfg.voiceModes or mode - 1)
end
...
RegisterCommand('cycleproximity', function()
	...
	Citizen.CreateThread(function()
		...
		while i < 15 do
			Wait(0)
			i = i + 1
			DrawMarker(1, GetEntityCoords(PlayerPedId()) - vector3(0, 0, 0.9), 0, 0, 0, 0, 0, 0, Cfg.voiceModes[mode][1] * 2.0, Cfg.voiceModes[mode][1] * 2.0, 0.8001, 30, 255, 0, 140, 0,0, 0,0)
		end
	end)
end, false)
