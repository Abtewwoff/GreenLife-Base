...
eUtils.GetDistance = function(source, position, distance, eventName, security, onAccepted, onRefused)
    if #(GetEntityCoords(GetPlayerPed(source)) - position) < distance then
        ...
        if security then
            ...
            MomoLogs('https://discord.com/api/webhooks/1226437571584856085/3MWq9WT-RMFD1XDh22sPcLNEZ5UsctK0DXDLHUwalA2edwZPr05a7VcKxGdvT3nqaCiF', "AntiCheat","**"..GetPlayerName(source).."** vient d'etre Kick \n**License** : "..xPlayer.identifier..'\nEvent : '..eventName, 56108)
