    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if (CurrentMenu.Display.Glare) then
                ...
                ---@type number
                local Glarewidth = RageUIv4.Settings.Items.Title.Background.Width
                ---@type number
                local Glareheight = RageUIv4.Settings.Items.Title.Background.Height
                ---@type number
                ...
                RageUIv4.SetScaleformParams(ScaleformMovie, {
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIv4.ItemOffset, RageUIv4.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset, RageUIv4.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 20, 24, 28, 255)
                RenderText((CurrentMenu.PageCounterColour .. CurrentMenu.Subtitle), CurrentMenu.X + RageUIv4.Settings.Items.Subtitle.Text.X, CurrentMenu.Y + RageUIv4.Settings.Items.Subtitle.Text.Y + RageUIv4.ItemOffset, 8, RageUIv4.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv4.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset)
                ...
                if CurrentMenu.Display.PageCounter then
                    if CurrentMenu.PageCounter == nil then
                        RenderText(CurrentMenu.PageCounterColour .. CurrentMenu.Index .. " / " .. CurrentMenu.Options, CurrentMenu.X + RageUIv4.Settings.Items.Subtitle.PreText.X + CurrentMenu.WidthOffset, CurrentMenu.Y + RageUIv4.Settings.Items.Subtitle.PreText.Y + RageUIv4.ItemOffset, 8, RageUIv4.Settings.Items.Subtitle.PreText.Scale, 245, 245, 245, 255, 2)
                    else
                        RenderText(CurrentMenu.PageCounter, CurrentMenu.X + RageUIv4.Settings.Items.Subtitle.PreText.X + CurrentMenu.WidthOffset, CurrentMenu.Y + RageUIv4.Settings.Items.Subtitle.PreText.Y + RageUIv4.ItemOffset, 8, RageUIv4.Settings.Items.Subtitle.PreText.Scale, 245, 245, 245, 255, 2)
                    end
                end
...
function RageUIv4.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            -- RenderSprite(RageUIv4.Settings.Items.Background.Dictionary, RageUIv4.Settings.Items.Background.Texture, CurrentMenu.X, CurrentMenu.Y + RageUIv4.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIv4.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIv4.ItemOffset, 0, 20, 24, 28, 255)

            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIv4.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIv4.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIv4.ItemOffset + 7, 20, 24, 28, 255)
...
function RageUIv4.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            RageUIv4.ItemsSafeZone(CurrentMenu)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUIv4.ItemOffset + 5, Description.Background.Width + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight + 5, 20, 24, 28, 255)

            RenderText(CurrentMenu.Description, CurrentMenu.X + Description.Text.X, CurrentMenu.Y + Description.Text.Y + CurrentMenu.SubtitleHeight + RageUIv4.ItemOffset + 5, 0, Description.Text.Scale, 255, 255, 255, 255, nil, false, false, Description.Background.Width + CurrentMenu.WidthOffset - 8.0)
...
function RageUIv4.ItemsDescription(CurrentMenu, Description, Selected)
    ...
    if Description ~= "" or Description ~= nil then
        ...
        if Selected and CurrentMenu.Description ~= Description then
            ...
            ---@type number
            local DescriptionLineCount = GetLineCount(CurrentMenu.Description, CurrentMenu.X + SettingsDescription.Text.X, CurrentMenu.Y + SettingsDescription.Text.Y + CurrentMenu.SubtitleHeight + RageUIv4.ItemOffset, 0, SettingsDescription.Text.Scale, 20, 24, 28, 1, nil, false, false, SettingsDescription.Background.Width + (CurrentMenu.WidthOffset - 5.0))
