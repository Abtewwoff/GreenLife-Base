...
-- RageUIv4.SliderProgress("Label", 1, 100, "CC MEC", {ProgressBackgroundColor = {R = 255, G = 0, B = 0, A = 255}, ProgressColor = {R = 120, G = 100, B = 0, A = 255}}, true, {})
function RageUIv4.SliderProgress(Label, ProgressStart, ProgressMax, Description, Style, Enabled, Actions)
