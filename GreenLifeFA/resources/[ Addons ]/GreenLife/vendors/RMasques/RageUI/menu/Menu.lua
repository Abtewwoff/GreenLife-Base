...
---@param B number
---@param A number
---@return RageUIMasquesMenus
---@public
function RageUIMasques.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIMasques.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 80
    Menu.Parent = nil
    Menu.WidthOffset = RageUIMasques.UI.Style[RageUIMasques.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIMasques.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIMasques.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIMasques.Settings.Items.Subtitle.Text.Y, 0, RageUIMasques.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIMasques.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIMasques.Menus)
end
...
---@return RageUIMasquesMenus
---@public
function RageUIMasques.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIMasques.CreateMenu(Title or ParentMenu.Title, Subtitle or string.upper(ParentMenu.Subtitle), X or ParentMenu.X, Y or ParentMenu.Y)
...
function RageUIMasques.Menus:DisplayHeader(boolean)
    self.Display.Header = boolean;
    return self.Display.Header;
end

function RageUIMasques.Menus:DisplayGlare(boolean)
    self.Display.Glare = boolean;
    return self.Display.Glare;
end

function RageUIMasques.Menus:DisplaySubtitle(boolean)
    self.Display.Subtitle = boolean;
    return self.Display.Subtitle;
end

function RageUIMasques.Menus:DisplayNavigation(boolean)
    self.Display.Navigation = boolean;
    return self.Display.Navigation;
end

function RageUIMasques.Menus:DisplayInstructionalButton(boolean)
    self.Display.InstructionalButton = boolean;
    return self.Display.InstructionalButton;
end

function RageUIMasques.Menus:DisplayPageCounter(boolean)
...
---@return nil
---@public
function RageUIMasques.Menus:SetTitle(Title)
    self.Title = Title
end

function RageUIMasques.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIMasques.Menus:GetStyleSize()
    if (self.WidthOffset == 100) then
        return "RageUIMasques"
...
---@return void
---@public
function RageUIMasques.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIMasques.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIMasques.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIMasques.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIMasques.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIMasques.Settings.Items.Subtitle.Text.X, self.Y + RageUIMasques.Settings.Items.Subtitle.Text.Y, 0, RageUIMasques.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIMasques.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIMasques.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIMasques.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function RageUIMasques.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIMasques.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIMasques.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIMasques.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIMasques.Menus:Closable(boolean)
...
function RageUIMasques.Menus:AddInstructionButton(button)
...
function RageUIMasques.Menus:RemoveInstructionButton(button)
...
function RageUIMasques.Menus:UpdateInstructionalButtons(Visible)
