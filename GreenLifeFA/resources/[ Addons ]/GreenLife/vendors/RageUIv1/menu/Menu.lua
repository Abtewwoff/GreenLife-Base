function RageUIv1.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = RageUIv1.UI.Style[RageUIv1.UI.Current].Width
    Menu.Open = false
...
function RageUIv1.Menus:SetPageCounter(txt)
...
---@return nil
---@public
function RageUIv1.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIv1.Settings.Items.Subtitle.Text.X, self.Y + RageUIv1.Settings.Items.Subtitle.Text.Y, 0, RageUIv1.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv1.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
