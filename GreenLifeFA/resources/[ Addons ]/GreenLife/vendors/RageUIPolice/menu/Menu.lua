...
---@return table
---@public
function RageUIPolice.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIPolice.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 80
    Menu.Parent = nil
    Menu.WidthOffset = RageUIPolice.UI.Style[RageUIPolice.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIPolice.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIPolice.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIPolice.Settings.Items.Subtitle.Text.Y, 0, RageUIPolice.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIPolice.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIPolice.Menus)
end
...
---@return table
---@public
function RageUIPolice.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function RageUIPolice.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function RageUIPolice.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIPolice.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIPolice.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIPolice.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIPolice.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIPolice.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIPolice.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIPolice.Settings.Items.Subtitle.Text.X, self.Y + RageUIPolice.Settings.Items.Subtitle.Text.Y, 0, RageUIPolice.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIPolice.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIPolice.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIPolice.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function RageUIPolice.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIPolice.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIPolice.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIPolice.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIPolice.Menus:Closable(boolean)
...
function RageUIPolice.Menus:AddInstructionButton(button)
...
function RageUIPolice.Menus:RemoveInstructionButton(button)
...
function RageUIPolice.Menus:UpdateInstructionalButtons(Visible)
