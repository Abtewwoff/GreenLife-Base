...
AddEventHandler("esx:playerLoaded", function(_, xPlayer)
    ...
    if (xPlayer) then  
		SendLogs("Connexion Joueur", "GreenLife | Connexion", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de se connecter", "https://discord.com/api/webhooks/1226436117314928761/ReBAnVTl_rWtANuXoo3Sz1tUeDewBEe9qMW0ebCtvrSvSY5ONsG4sBViFs72u9-bjGQK")
	end
end)
...
AddEventHandler("playerDropped", function(reason)
    ...
    if (xPlayer) then 
		SendLogs("Déconnexion Joueur", "GreenLife | Déconnexion", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de se déconnecter pour la raison (***"..reason.."***)", "https://discord.com/api/webhooks/1226436022456549386/ozZgPdWAcSALbBxAXSB7pH67JVN3On9AU28Dof0ErnlaUHpqCkMe7Q3iB8xAbyAzSycs")
	end
end)
