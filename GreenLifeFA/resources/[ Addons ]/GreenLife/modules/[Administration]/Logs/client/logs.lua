...
WeaponNames = {
	...
	[tostring(GetHashKey('WEAPON_HAMMER'))] = 'Hache',
	[tostring(GetHashKey('WEAPON_BAT'))] = 'Pioche Licorne',
	...
	[tostring(GetHashKey('WEAPON_KATANA'))] = 'Sabre Lazer Bleu',
	[tostring(GetHashKey('WEAPON_KATANA2'))] = 'Sabre Lazer Rouge',
	[tostring(GetHashKey('WEAPON_KATANA3'))] = 'Sabre Lazer Vert',
	[tostring(GetHashKey('WEAPON_KATANA4'))] = 'Katana',
	[tostring(GetHashKey('WEAPON_THROWINGCHAIR'))] = 'Marteau Géant',
	...
	[tostring(GetHashKey('WEAPON_MIDASGUN'))] = 'Midas',
	...
	[tostring(GetHashKey('WEAPON_CARBINERIFLE1'))] = 'Carbine Rifle',
	...
	[tostring(GetHashKey('WEAPON_MEGAPHONE'))] = 'Megaphone', 
	[tostring(GetHashKey('WEAPON_ANTIDOTE'))] = 'Antidote',
	...
	[tostring(GetHashKey('WEAPON_THROWINGAXE'))] = 'Tomahawk',
	...
	[tostring(GetHashKey('WEAPON_RUN_OVER_BY_CAR'))] = 'en voiture',
	...
	[tostring(GetHashKey('WEAPON_PISTOL501'))] = 'Deagle',
	[tostring(GetHashKey('WEAPON_PENETRATOR'))] = 'Penetrator',
}

AllLogs = true											-- Enable/Disable All Logs Channel
postal = false  											-- set to false if you want to disable nerest postal (https://forum.cfx.re/t/release-postal-code-map-minimap-new-improved-v1-2/147458)
username = "GreenLife" 							        -- Bot Username
avatar = "https://cdn.discordapp.com/attachments/1324642599948128256/1324644480573378560/White_Black_Modern_Initial_Logo-.png?ex=6778e6ce&is=6777954e&hm=6e3c776382bb7c4d402f5122c0c0fc374f5510185024de9b5ce6561cb7a58f40&"				-- Bot Avatar
communtiyName = "vqkz1"					            -- Icon top of the Embed
communtiyLogo = "https://cdn.discordapp.com/attachments/1324642599948128256/1324644480573378560/White_Black_Modern_Initial_Logo-.png?ex=6778e6ce&is=6777954e&hm=6e3c776382bb7c4d402f5122c0c0fc374f5510185024de9b5ce6561cb7a58f40&"		-- Icon top of the Embed


weaponLog = true  			-- set to false to disable the shooting weapon logs
weaponLogDelay = 500		-- delay to wait after someone fired a weapon to check again in ms (put to 0 to disable) Best to keep this at atleast 1000
...
CreateThread(function()
	...
	while true do
		...
		if IsEntityDead(PlayerPedId()) and not SendLogs then
			Interval = 500
			...
			elseif (Killer == nil) then
				...
				elseif IsVK(DeathCauseHash) then
					DeathReason = 'a carkill'
				else
					DeathReason = 'a tuer'
				end
			end
			if DeathReason == 'committed suicide' or DeathReason == 'suicide' then
...
--------------------------------DISABLE BY J0THUN, SA SERT A QUOI SA ENCORE
-- CreateThread(function()
-- 	while true do
...
function ShowDebug(text)
	...
	AddTextComponentSubstringPlayerName("~g~GameCore Debug:~s~\n"..text)
