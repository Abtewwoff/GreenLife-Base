...
CreateThread(function()
	local pos = vector3(-1338.129, -1278.200, 4.872)
	...
	while true do
		...
		if #(pCoords - pos) <= 10 then
			interval = 1
			--DrawMarker(Config.Get.Marker.Type, pos, 0, 0, 0, Config.Get.Marker.Rotation, nil, nil, Config.Get.Marker.Size[1], Config.Get.Marker.Size[2], Config.Get.Marker.Size[3], 30, 255, 0, 170, 0, 1, 0, 0, nil, nil, 0)
