    ...
    while menu do
        ...
        RageUI.IsVisible(menu, function()
            ...
            RageUI.Button("Coffre", nil, { RightLabel = "→" }, true, {
                onSelected = function()
                    TriggerServerEvent("GreenLife:Inventory:OpenSecondInventory", "properties", info.name)
        ...
        RageUI.IsVisible(actionCoffre, function()
            ...
            RageUI.Button("Rendre la Propriete", "~r~Vous renderez cette Propriete pour "..math.floor((price*75)/100).."$", { RightLabel = "→" }, not notPersonnal, {
                onSelected = function()
