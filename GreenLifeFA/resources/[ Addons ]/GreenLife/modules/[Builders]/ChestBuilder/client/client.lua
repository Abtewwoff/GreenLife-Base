...
local ChestBuilderMenu = RageUI.CreateMenu("", "Coffre Builder", 0, 0, 'menustyle', 'interaction_bgd')
local ChestBuilderMenuInteract = RageUI.CreateSubMenu(ChestBuilderMenu, "", "Coffre Builder", 0, 0, 'menustyle', 'interaction_bgd')
local ChestBuilderMenuChestIneract = RageUI.CreateSubMenu(ChestBuilderMenu, "", "Coffre Builder", 0, 0, 'menustyle', 'interaction_bgd') 

local ChestMenu = RageUI.CreateMenu("", "Coffre", 0, 0, 'menustyle', 'interaction_bgd')
local ChestMenuMyInventory = RageUI.CreateSubMenu(ChestMenu, "", "Votre Inventaire", 0, 0, 'menustyle', 'interaction_bgd')
local ChestInventory = RageUI.CreateSubMenu(ChestMenu, "", "Inventaire du coffre", 0, 0, 'menustyle', 'interaction_bgd')
            ...
            if dif < 10 and v.job == ESX.PlayerData.job.name then
                ...
                if dif < 2 then
                    ...
                    if IsControlJustPressed(0, 38) then
                        ...
                        TriggerServerEvent("GreenLife:Inventory:OpenSecondInventory", "coffrebuilder", v.id)
                    end
                end
            end
        end
