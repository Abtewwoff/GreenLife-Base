...
AddEventHandler("RS_AutoEvents_StopEvent", function(data, zone)
    ...
    ESX.ShowAdvancedNotification('Notification', 'Event', "Terminé! Tu n'étais pas encore arrivé? Rien à foutre vient plus rapidement la prochaine fois!", 'CHAR_ILLEGAL2', 2)
    EventStop = true
    removeBlips()
end)
