...
function avionEvent(data, zone)
    ...
    Citizen.CreateThread(function()
        ...
        ESX.ShowAdvancedNotification('Notification', 'Event', data.message, 'CHAR_ILLEGAL2', 2)
        ...
        Citizen.CreateThread(function()
            ...
            while not EventStop do
                ...
                if closeToEvent then
                    ...
                    -- TriggerEvent("ui:showInteraction", "E", tip)
                end
            end
        end)
        ...
        if not EventStop then
            ...
            while ArmesRecup < 10 do
                ...
                if ArmesRecup >= 10 then
                    ESX.ShowAdvancedNotification('Notification', 'Event', "Tu as terminé le travail avant les autres ! On va leur laisser un peu de temps !", 'CHAR_ILLEGAL2', 2)
                    Wait(10000)
                    for k,v in pairs(ObjTable) do
                        RemoveObj(v)
                    end
            ...
            ESX.ShowAdvancedNotification('Notification', 'Event', "Cargaison récupérée!", 'CHAR_ILLEGAL2', 2)
