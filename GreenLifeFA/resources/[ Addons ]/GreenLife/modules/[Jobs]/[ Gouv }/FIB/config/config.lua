FBI = {
    Vehicules = {
        ...
        {name = "15sub", label = "Subaru banalisé", minimum_grade = 3},--
        {name = "FBIGMC", label = "Granger FBI", minimum_grade = 4},
        {name = "FBITahoe", label = "Granger FBI Banalisé", minimum_grade = 4},
        {name = "19mustangbb", label = "Mustang FBI", minimum_grade = 4},
        ...
        {name = "", label = "Blindé FBI SOON", minimum_grade = 5},
    ...
    Tenues = {
        ...
        [1] = {
            label = "S'équiper de la tenue :~g~Consultant Fédéral",
            minimum_grade = 0,
            male = {
        ...
        [2] = {
            label = "S'équiper de la tenue :~g~Agent Aspirant",
            minimum_grade = 1,
            male = {
                ['tshirt_1'] = 15,  ['tshirt_2'] = 0,
                ['torso_1'] = 435,   ['torso_2'] = 0,
        ...
        [3] = {
            label = "S'équiper de la tenue :~g~Agent Fédéral",
            minimum_grade = 2,
            male = {
                ['tshirt_1'] = 15,  ['tshirt_2'] = 0,
                ['torso_1'] = 435,   ['torso_2'] = 0,
        ...
        [4] = {
            label = "S'équiper de la tenue :~g~Agent Spécial",
            minimum_grade = 3,
            male = {
                ['tshirt_1'] = 15,  ['tshirt_2'] = 0,
                ['torso_1'] = 435,   ['torso_2'] = 0,
        ...
        [5] = {
            label = "S'équiper de la tenue :~g~Agent Spécial Superviseur",
            minimum_grade = 4,
            male = {
                ['tshirt_1'] = 15,  ['tshirt_2'] = 0,
                ['torso_1'] = 435,   ['torso_2'] = 0,
        ...
        [6] = {
            label = "S'équiper de la tenue :~g~Agent Spécial en Charge",
            minimum_grade = 5,
            male = {
                ['tshirt_1'] = 15,  ['tshirt_2'] = 0,
                ['torso_1'] = 435,   ['torso_2'] = 0,
        ...
        [7] = {
            label = "S'équiper de la tenue :~g~Agent Spécial de Coordination",
            minimum_grade = 6,
            male = {
                ['tshirt_1'] = 15,  ['tshirt_2'] = 0,
                ['torso_1'] = 435,   ['torso_2'] = 0,
        ...
        [8] = {
            label = "S'équiper de la tenue :~g~Directeur d'Agence",
            minimum_grade = 7,
            male = {
                ['tshirt_1'] = 15,  ['tshirt_2'] = 0,
                ['torso_1'] = 435,   ['torso_2'] = 0,
