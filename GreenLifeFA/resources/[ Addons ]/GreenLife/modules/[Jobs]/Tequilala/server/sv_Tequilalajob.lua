...
AddEventHandler('Ouvre:tequilala', function()
    ...
    if (not TimeoutJob4[xPlayer.identifier] or GetGameTimer() - TimeoutJob4[xPlayer.identifier] > 600000) then
        ...
        for i=1, #xPlayers, 1 do
            ...
            TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Tequilala', '', 'Tequilala est désormais Ouvert~s~ !', 'CHAR_MP_STRIPCLUB_PR', 8)
        end
    else
...
AddEventHandler('Ferme:tequilala', function()
    ...
    if (not TimeoutJob4[xPlayer.identifier] or GetGameTimer() - TimeoutJob4[xPlayer.identifier] > 600000) then
        ...
        for i=1, #xPlayers, 1 do
            local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
            TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Tequilala', '', 'L\'Tequilala est désormais Fermer~s~ !', 'CHAR_MP_STRIPCLUB_PR', 8)
        end
    else
        xPlayer.showNotification("Vous devez attendre 10 minutes avant de pouvoir faire une annonce à nouveau.");
    end
...
AddEventHandler('Recrutement:tequilala', function()
    ...
    if (not TimeoutJob4[xPlayer.identifier] or GetGameTimer() - TimeoutJob4[xPlayer.identifier] > 600000) then
        ...
        for i=1, #xPlayers, 1 do
            local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
            TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Tequilala', '', 'Les Recrutement en cours, rendez-vous au Vanilla Tequilala !', 'CHAR_MP_STRIPCLUB_PR', 8)
        end
    else
        xPlayer.showNotification("Vous devez attendre 10 minutes avant de pouvoir faire une annonce à nouveau.");
    end
...
AddEventHandler('Tequilala:BuyEau', function()
    ...
    if xPlayer.canCarryItem('water', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **Eau", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyIceTea', function()
    ...
    if xPlayer.canCarryItem('icetea', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **icetea", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyLimonade', function()
    ...
    if xPlayer.canCarryItem('limonade', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **limonade", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyVine', function()
    ...
    if xPlayer.canCarryItem('vine', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **vine", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyWhiskycoca', function()
    ...
    if xPlayer.canCarryItem('wiskycoca', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **wiskycoca", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyMojito', function()
    ...
    if xPlayer.canCarryItem('mojito', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **mojito", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyCoca', function()
    ...
    if xPlayer.canCarryItem('coca', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **coca", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyFanta', function()
    ...
    if xPlayer.canCarryItem('fanta', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **fanta", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyChips', function()
    ...
    if xPlayer.canCarryItem('chips', 1) then
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **chips", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyCacahuete', function()
    ...
    if xPlayer.canCarryItem('cacahuete', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **cacahuete", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
...
AddEventHandler('Tequilala:BuyOlive', function()
    ...
    if xPlayer.canCarryItem('olive', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **olive", 'https://discord.com/api/webhooks/1138291154547392604/pPJ0xWe0wpBhOAC7Kfs4rIo2wbx2ihTJvdYClTMqKrO9W3uhzxyKlfXIdej4ZhbIPGF8')
