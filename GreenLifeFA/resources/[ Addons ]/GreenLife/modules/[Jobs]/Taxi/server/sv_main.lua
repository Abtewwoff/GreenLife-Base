...
Taxi.Config = {
    ...
    vehicle = {
        passengerSeat = 1,
        model = {
            [GetHashKey("nkstxtaxi")] = { model = GetHashKey("nkstxtaxi"), name = 'nkstxtaxi' },
            [GetHashKey("nkrhineharttaxi")] = { model = GetHashKey("nkrhineharttaxi"), name = 'nkrhineharttaxi' },
            [GetHashKey("nklandstalker2taxi")] = { model = GetHashKey("nklandstalker2taxi"), name = 'nklandstalker2taxi' },
            [GetHashKey("nkfugitivetaxi")] = { model = GetHashKey("nkfugitivetaxi"), name = 'nkfugitivetaxi' },
            [GetHashKey("nkdraftertaxi")] = { model = GetHashKey("nkdraftertaxi"), name = 'nkdraftertaxi' },
            [GetHashKey("nkballer7taxi")] = { model = GetHashKey("nkballer7taxi"), name = 'nkballer7taxi' },
        },
