		...
		while open do 
            ...
            if ServiceJournaliste then
                ...
                RageUI.IsVisible(subMenu8,function() 
                    ...
                    RageUI.Button("Annonce ~g~Recrutement", nil, {RightLabel = "→→"}, not codesCooldown3, {
                        onSelected = function()
                            codesCooldown3 = true 
                            TriggerServerEvent('Recrutement:journalist')
                        end
                    })
                    RageUI.Button("Annonce ~g~Custom", nil, {RightLabel = "→→"}, not codesCooldown4, {
                        onSelected = function()
                            codesCooldown4 = true 
...
Citizen.CreateThread(function()
	...
	local blip = AddBlipForCoord(-592.68853759766, -928.69470214844, 23.869079589844)  
	...
	AddTextComponentSubstringPlayerName('[Entreprise] Weazel News') -- Nom du blip
                ...
                if dist <= 15.0 then
                    ...
                    if ServiceJournaliste then
                        ...
                        if dist <= 1.0 then
                            ...
                            -- TriggerEvent("ui:showInteraction", "E", " pour ouvrir le garage")
