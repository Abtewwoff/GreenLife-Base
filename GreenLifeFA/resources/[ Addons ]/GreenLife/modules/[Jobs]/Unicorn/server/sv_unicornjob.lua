...
AddEventHandler('Ouvre:unicorn', function()
    ...
    if (not TimeoutJob4[xPlayer.identifier] or GetGameTimer() - TimeoutJob4[xPlayer.identifier] > 600000) then
        ...
        for i=1, #xPlayers, 1 do
            ...
            TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Unicorn', '', 'L\'Unicorn est désormais Ouvert~s~ !', 'CHAR_UNICORN', 8)
        end
    else
...
AddEventHandler('Ferme:unicorn', function()
    ...
    if (not TimeoutJob4[xPlayer.identifier] or GetGameTimer() - TimeoutJob4[xPlayer.identifier] > 600000) then
        ...
        for i=1, #xPlayers, 1 do
            local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
            TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Unicorn', '', 'L\'Unicorn est désormais Fermer~s~ !', 'CHAR_UNICORN', 8)
        end
    else
        xPlayer.showNotification("Vous devez attendre 10 minutes avant de pouvoir faire une annonce à nouveau.");
    end
...
AddEventHandler('Recrutement:unicorn', function()
    ...
    if (not TimeoutJob4[xPlayer.identifier] or GetGameTimer() - TimeoutJob4[xPlayer.identifier] > 600000) then
        ...
        for i=1, #xPlayers, 1 do
            local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
            TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'Unicorn', '', 'Les Recrutement en cours, rendez-vous au Vanilla Unicorn !', 'CHAR_UNICORN', 8)
        end
    else
        xPlayer.showNotification("Vous devez attendre 10 minutes avant de pouvoir faire une annonce à nouveau.");
    end
...
AddEventHandler('Unicorn:BuyEau', function()
    ...
    if xPlayer.canCarryItem('water', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **Eau", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyIceTea', function()
    ...
    if xPlayer.canCarryItem('icetea', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **icetea", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyLimonade', function()
    ...
    if xPlayer.canCarryItem('limonade', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **limonade", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyVine', function()
    ...
    if xPlayer.canCarryItem('vine', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **vine", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyWhiskycoca', function()
    ...
    if xPlayer.canCarryItem('wiskycoca', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **wiskycoca", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyMojito', function()
    ...
    if xPlayer.canCarryItem('mojito', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **mojito", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyCoca', function()
    ...
    if xPlayer.canCarryItem('coca', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **coca", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyFanta', function()
    ...
    if xPlayer.canCarryItem('fanta', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **fanta", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyChips', function()
    ...
    if xPlayer.canCarryItem('chips', 1) then
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **chips", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyCacahuete', function()
    ...
    if xPlayer.canCarryItem('cacahuete', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **cacahuete", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
...
AddEventHandler('Unicorn:BuyOlive', function()
    ...
    if xPlayer.canCarryItem('olive', 1) then
        ...
        logsBuyFrigo("[Achat Frigo] \n\n**Employé :** "..xPlayer.getFirstName().." "..xPlayer.getLastName().." - ("..xPlayer.name..")\n\n**Item acheter : **olive", 'https://discord.com/api/webhooks/1138290328596664481/NANnGCRHnNI1UPghyxACZ0jDRmEWR_tXPv0gM4xUb-ti-N45PKaJqwAIx-g8lnK9g_Nj')
