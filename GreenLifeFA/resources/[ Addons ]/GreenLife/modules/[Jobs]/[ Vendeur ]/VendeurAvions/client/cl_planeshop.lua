...
Citizen.CreateThread(function()
	...
	AddTextComponentString("[Entreprise] Concessionnaire Avions")
...
RegisterNetEvent('planeseller:onSpawnVehicle', function(menuData, vehicleNetworkId, vehicleProps)
    local data = menuData;
    -- exports["Abteww"]:GetByNetworkId(vehicleNetworkId, function(vehicle)
...
local subMenu8 = RageUI.CreateSubMenu(planeMain2, "Annonces", "Interaction")
