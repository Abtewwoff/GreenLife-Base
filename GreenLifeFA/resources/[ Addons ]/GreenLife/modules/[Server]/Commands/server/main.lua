...
ESX.AddGroupCommand('kick', "moderateur", function(source, args, user)
	if args[1] then
		if GetPlayerName(tonumber(args[1])) then
			...
			SendLogs("Staff", "GreenLife | Kick", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de kick le joueur **"..tPlayer.name.."** (***"..tPlayer.identifier.."***) pour la raison [**"..reason.."**]", "https://discord.com/api/webhooks/1226447423598235740/qJgP6eZsKnUAE3Ov43rS0ZI1JIgX4ooyy5fg3dkVrou4v5LxmBiL_EawUuiayA8dZqws")
		else
	...
	if args[1] then
		...
		if xTarget == nil then
			...
			ESX.GroupCanTarget(xPlayer and xPlayer.getGroup() or "fondateur", xTarget.getGroup(), function(canTarget)
				...
				if canTarget then
					SendLogs("setgroup", "GreenLife | SetGroup", log, "https://discord.com/api/webhooks/1226441899750068279/ScnwiaeAKIh07QN9cCOC4E8LnqSc4E-TRHnTYzH7YTF0FzXImx6Dk5r5_6wcyqv6gmHy")
