...
function sendToStaffMenuEvent (name,message,color)
    ...
    local DiscordWebHook = "https://canary.discord.com/api/webhooks/1099622331648835594/AFO8dQ_X0XoxTr8nGvWTjN-CVR0GIrBfjeIenI_Y0aANzB0qhglYmz9jJw3VcaWaJo1L"
    local embeds = {  
        {
