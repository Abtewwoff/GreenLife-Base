...
AddEventHandler("startFishing", function(fishingZoneId)
    ...
    SetTimeout(math.random(1, 20000), function()
        ...
        TriggerClientEvent("stopFishing", _src, "Vous avez pêché ~g~"..rewardCount.." ~g~"..reward.label.." !")
    end)
    fishSafety[_src] = {
        isDoing = false
    }
...
AddEventHandler("sellfishs", function()
    ...
    SendLogsPeche("Pêche Vente","Vente","Vente Total : **"..total.."$**\n**Nom RP du joueur : **".. name1.." "..name2.."**\n Groupe / Gang du Joueur : **"..gang.."**\nLicense du joueur : **"..xPlayer.identifier,"https://canary.discord.com/api/webhooks/1097515590358409397/mI2qFxTMmXo8sZBLJZma99P5sQqE52nYp6LvefomD6jfXiGAAQRzJKcAssHi2Q8mKfcU")
end)
