...
AddEventHandler('esx_basicneeds:healPlayer', function()
	...
	SetPedHealth(playerPed, GetEntityMaxHealth(playerPed))
end)
...
AddEventHandler('esx_status:loaded', function(status)
	...
	-- TriggerEvent('GreenLife:Status:RegisterStatus', 'hunger', 1000000, function(status)
	-- 	status.remove(100)
	-- end)

	-- TriggerEvent('GreenLife:Status:RegisterStatus', 'thirst', 1000000, function(status)
	-- 	status.remove(75)
	-- end)
	...
	-- 				Wait(150000)
    --                 ESX.showNotification("~r~Attention\n~s~Tu semble avoir faim...")
    --             end
