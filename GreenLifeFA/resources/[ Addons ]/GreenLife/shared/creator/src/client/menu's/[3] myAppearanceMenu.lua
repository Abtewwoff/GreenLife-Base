...
function Render:myAppearanceMenu()
    ...
    RageUIClothes.List(__["hair"], Coiffure, filter.hair.index, nil, {}, true, { onActive = function() UtilsCreator:OnRenderCam() end, onListChange = function(Index, Item) filter.hair.index = Index TriggerEvent(CreatorConfig.events.skinchanger..':change', 'hair_1', filter.hair.index - 1) end })
    RageUIClothes.List(__["beard"], Barbes, filter.beard.index, nil, {}, true, { onActive = function() UtilsCreator:OnRenderCam() end, onListChange = function(Index, Item) filter.beard.index = Index TriggerEvent(CreatorConfig.events.skinchanger..':change', 'beard_1', filter.beard.index - 1) end })
    RageUIClothes.List(__["eyebrow"], Sourcils, filter.eyebrow.index, nil, {}, true, { onActive = function() UtilsCreator:OnRenderCam() end, onListChange = function(Index, Item) filter.eyebrow.index = Index TriggerEvent(CreatorConfig.events.skinchanger..':change', 'eyebrows_1', filter.eyebrow.index - 1) end })
    RageUIClothes.List(__["eyecolor"], CouleurYeux, filter.eyecolor.index, nil, {}, true, { onActive = function() UtilsCreator:OnRenderCam() end, onListChange = function(Index, Item) filter.eyecolor.index = Index TriggerEvent(CreatorConfig.events.skinchanger..':change', 'eye_color', filter.eyecolor.index - 1) end })
    RageUIClothes.List(__["makeup"], Maquillage, filter.makeup.index, nil, {}, true, { onActive = function() UtilsCreator:OnRenderCam() end, onListChange = function(Index, Item) filter.makeup.index = Index TriggerEvent(CreatorConfig.events.skinchanger..':change', 'makeup_1', filter.makeup.index - 1) end })
    RageUIClothes.List(__["lipstick"], Levres, filter.lipstick.index, nil, {}, true, { onActive = function() UtilsCreator:OnRenderCam() end, onListChange = function(Index, Item) filter.lipstick.index = Index TriggerEvent(CreatorConfig.events.skinchanger..':change', 'lipstick_1', filter.lipstick.index - 1) end })
