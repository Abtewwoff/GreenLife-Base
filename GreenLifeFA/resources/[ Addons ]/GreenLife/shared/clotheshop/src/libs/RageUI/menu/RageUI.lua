    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if (CurrentMenu.Display.Glare) then
                ...
                ---@type number
                local Glarewidth = RageUIClothes.Settings.Items.Title.Background.Width
                ---@type number
                local Glareheight = RageUIClothes.Settings.Items.Title.Background.Height
                ---@type number
                ...
                RageUIClothes.SetScaleformParams(ScaleformMovie, {
            ...
            RenderText(CurrentMenu.Title, CurrentMenu.X + RageUIClothes.Settings.Items.Title.Text.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUIClothes.Settings.Items.Title.Text.Y, CurrentMenu.TitleFont, CurrentMenu.TitleScale, 255, 255, 255, 255, 1)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIClothes.ItemOffset, RageUIClothes.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset, RageUIClothes.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 20, 24, 28, 255)
                RenderText((CurrentMenu.PageCounterColour .. CurrentMenu.Subtitle), CurrentMenu.X + RageUIClothes.Settings.Items.Subtitle.Text.X, CurrentMenu.Y + RageUIClothes.Settings.Items.Subtitle.Text.Y + RageUIClothes.ItemOffset, 8, RageUIClothes.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIClothes.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset)
                ...
                if CurrentMenu.Display.PageCounter then
                    if CurrentMenu.PageCounter == nil then
                        RenderText(CurrentMenu.PageCounterColour .. CurrentMenu.Index .. " / " .. CurrentMenu.Options, CurrentMenu.X + RageUIClothes.Settings.Items.Subtitle.PreText.X + CurrentMenu.WidthOffset, CurrentMenu.Y + RageUIClothes.Settings.Items.Subtitle.PreText.Y + RageUIClothes.ItemOffset, 8, RageUIClothes.Settings.Items.Subtitle.PreText.Scale, 245, 245, 245, 255, 2)
                    else
                        RenderText(CurrentMenu.PageCounter, CurrentMenu.X + RageUIClothes.Settings.Items.Subtitle.PreText.X + CurrentMenu.WidthOffset, CurrentMenu.Y + RageUIClothes.Settings.Items.Subtitle.PreText.Y + RageUIClothes.ItemOffset, 8, RageUIClothes.Settings.Items.Subtitle.PreText.Scale, 245, 245, 245, 255, 2)
                    end
                end
...
function RageUIClothes.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            -- RenderSprite(RageUIClothes.Settings.Items.Background.Dictionary, RageUIClothes.Settings.Items.Background.Texture, CurrentMenu.X, CurrentMenu.Y + RageUIClothes.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIClothes.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIClothes.ItemOffset, 0, 20, 24, 28, 255)

            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIClothes.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIClothes.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIClothes.ItemOffset + 7, 20, 24, 28, 255)
...
function RageUIClothes.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            RageUIClothes.ItemsSafeZone(CurrentMenu)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset + 5, Description.Background.Width + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight + 5, 20, 24, 28, 255)

            RenderText(CurrentMenu.Description, CurrentMenu.X + Description.Text.X, CurrentMenu.Y + Description.Text.Y + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset + 5, 0, Description.Text.Scale, 255, 255, 255, 255, nil, false, false, Description.Background.Width + CurrentMenu.WidthOffset - 8.0)
...
function RageUIClothes.ItemsDescription(CurrentMenu, Description, Selected)
    ...
    if Description ~= "" or Description ~= nil then
        ...
        if Selected and CurrentMenu.Description ~= Description then
            ...
            ---@type number
            local DescriptionLineCount = GetLineCount(CurrentMenu.Description, CurrentMenu.X + SettingsDescription.Text.X, CurrentMenu.Y + SettingsDescription.Text.Y + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, 0, SettingsDescription.Text.Scale, 20, 24, 28, 1, nil, false, false, SettingsDescription.Background.Width + (CurrentMenu.WidthOffset - 5.0))
