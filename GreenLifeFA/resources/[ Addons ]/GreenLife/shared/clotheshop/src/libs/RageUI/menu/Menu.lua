function RageUIClothes.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIClothes.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = RageUIClothes.UI.Style[RageUIClothes.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIClothes.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIClothes.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIClothes.Settings.Items.Subtitle.Text.Y, 0, RageUIClothes.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIClothes.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIClothes.Menus)
end
...
---@param B number
---@param A number
---@return RageUIClothesMenus
---@public
function RageUIClothes.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIClothes.CreateMenu(Title or ParentMenu.Title, Subtitle or ParentMenu.Subtitle, X or ParentMenu.X, Y or ParentMenu.Y)
...
function RageUIClothes.Menus:DisplayHeader(boolean)
    self.Display.Header = boolean;
    return self.Display.Header;
end

function RageUIClothes.Menus:DisplayGlare(boolean)
    self.Display.Glare = boolean;
    return self.Display.Glare;
end

function RageUIClothes.Menus:DisplaySubtitle(boolean)
    self.Display.Subtitle = boolean;
    return self.Display.Subtitle;
end

function RageUIClothes.Menus:DisplayNavigation(boolean)
    self.Display.Navigation = boolean;
    return self.Display.Navigation;
end

function RageUIClothes.Menus:DisplayInstructionalButton(boolean)
    self.Display.InstructionalButton = boolean;
    return self.Display.InstructionalButton;
end

function RageUIClothes.Menus:DisplayPageCounter(boolean)
...
---@return nil
---@public
function RageUIClothes.Menus:SetTitle(Title)
    self.Title = Title
end

function RageUIClothes.Menus:SetStyleSize(Value)
    local witdh
...
function RageUIClothes.Menus:SetPageCounter(txt)
...
---@return any
---@public
function RageUIClothes.Menus:GetStyleSize()
    if (self.WidthOffset == 100) then
        return "RageUIClothes"
...
---@return void
---@public
function RageUIClothes.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIClothes.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIClothes.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIClothes.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIClothes.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function RageUIClothes.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIClothes.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIClothes.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIClothes.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIClothes.Menus:Closable(boolean)
...
function RageUIClothes.Menus:AddInstructionButton(button)
...
function RageUIClothes.Menus:RemoveInstructionButton(button)
...
function RageUIClothes.Menus:UpdateInstructionalButtons(Visible)
