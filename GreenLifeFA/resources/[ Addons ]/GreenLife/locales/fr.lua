...
Locales['fr'] = {
    ...
    ['remaining_msg'] = 'il reste ~g~%s~s~ secondes avant votre sortie de prison',
	...
	['press_to_rob'] = 'appuyer sur ~INPUT_CONTEXT~ pour braquer ~g~',
	['robbery_of'] = 'braquage de banque: ~r~',
	['seconds_remaining'] = ' secondes restantes',
	['robbery_cancelled_at'] = '~r~ Braquage annulé à: ~g~',
	['robbery_has_cancelled'] = '~r~ le braquage à été annulé: ~g~',
	['already_robbed'] = 'cette banque a déjà été braqué. Veuillez attendre: ',
	['seconds'] = 'secondes.',
	['rob_in_prog'] = '~r~ braquage en cours à: ~g~',
	...
	['robbery_complete_at'] = '~r~ Braquage terminé à: ~g~',
	...
	['rob_in_prog2'] = '~r~ Braquage en cours à: ~g~',
	...
	['min_two_police'] = 'Il doit y avoir au moins ~g~ ',
	...
	['copsforsell'] = 'Il doit y avoir au moins ~g~ ',
	['copsforsell2'] = ' policiers en ville pour revendre les bijoux.',
	['goldsell'] = '~g~Bijoux~s~ vente en cours',
	['field'] = 'Pressez ~g~E~s~ pour ~g~voler~s~ les bijoux',
	['collectinprogress'] = 'récupération des bijoux en cours...',
	['lester'] = '~g~Vous avez braqué la bijouterie! Maintenant, revendez les bijoux !',
	--Proprety
	['have_withdrawn'] = 'vous avez pris ~g~x%s~s~ ~g~%s~s~',
	['have_deposited'] = 'vous avez déposé ~g~x%s~s~ ~g~%s~s~',
	...
	['player_cannot_hold'] = 'vous n\'avez pas assez ~g~de place~s~ dans votre inventaire!',
	--Instance
	...
	['act_imp_police'] = 'action ~r~impossible~s~, ~g~policiers~s~: ~g~%s~s~/~g~%s~s~ online',
	['inv_full_coke'] = 'vous ne pouvez plus ramasser de Cocaine, votre inventaire est ~r~plein~s~',
	['pickup_in_prog'] = '~g~Ramassage en cours~s~...',
	...
	['packing_in_prog'] = '~g~Conditonnement en cours~s~...',
	...
	['used_one_weed'] = 'Vous avez utilisé 1 Pochon de ~g~weed',
	...
	['used_one_opium'] = 'Vous avez utilisé 1 Pochon de ~g~opium',
	...
	['exit_marker'] = 'press ~INPUT_CONTEXT~ to cancel the ~g~process~s~',
	-- Blips
	...
	['with'] = 'avec',
	-- Basic Needs
	['used_bread'] = 'Vous avez mangé un ~g~pain~s~',
	['used_water'] = 'Vous avez bu une bouteille ~g~eau~s~',
	['used_vine'] = 'Vous avez bu une bouteille de ~g~vin~s~',
	['used_mojito'] = 'Vous avez bu un ~g~mojito~s~',
	['used_icetea'] = 'Vous avez bu un ~g~icetea~s~',
	['used_wiskycoca'] = 'Vous avez bu un ~g~wisky coca~s~',
	['used_coca'] = 'Vous avez bu un ~g~coca~s~',
	['used_limonade'] = 'Vous avez bu une ~g~limonade~s~',
	['used_fanta'] = 'Vous avez bu un ~g~fanta~s~',
	['used_chips'] = 'Vous avez mangé des ~g~chips~s~',
	['used_cacahuete'] = 'Vous avez mangé des ~g~cacahuètes~s~',
	['used_olive'] = 'Vous avez mangé des ~g~olives~s~',
	['used_burgerclassique'] = 'Vous avez mangé un ~g~Burger~s~',
	['used_frites'] = 'Vous avez mangé des ~g~frites~s~',
	['used_coca'] = 'Vous avez bu un ~g~orangina~s~',
	--Instance
	['left_instance'] = 'vous avez quitté l\'instance',
	['invite_expired'] = 'invitation expirée',
	['press_to_enter'] = 'appuyez sur ~INPUT_CONTEXT~ pour entrer dans l\'instance',
	...
	['revive_complete'] = 'vous avez réanimé ~g~%s~s~',
	['revive_complete_award'] = 'vous avez réanimé ~g~%s~s~, ~g~$%s~s~',
	['heal_inprogress'] = 'vous avez etait soigné!',
	['heal_complete'] = 'vous avez soigné ~g~%s~s~',
	...
	-- Death
	['please_wait'] = 'réapparition dans ~g~%s minutes %s secondes~s~',
	['press_respawn'] = 'appuyez sur [~g~E] pour réapparaître.',
	['respawn_now_fine'] = 'réapparaître maintenant pour ~g~$%s [Appuyez ~g~E]',
	...
	['not_enough_medikit'] = 'vous n\'avez pas de ~g~kit de soin.',
	['not_enough_bandage'] = 'vous n\'avez pas de ~g~bandage.',
	...
	['installed'] = 'installé',
	['already_own'] = 'vous possédez déjà: ~g~%s~s~',
	['not_enough_money'] = 'Vous n\'avez pas assez d\'argent!',
  ...
  -- Cosmetics
	...
	['cartEmptyTxt'] = 'Il n\'y a pas d\'articles dans le panier!',
		...
		['auto_fine_notif'] = 'Excès de vitesse: ~g~%sKm/h ~r~au lieu de ~g~%sKm/h.',
		
		['police_call'] = '~g~Excès de vitesse majeur sur ',
		...
		['remove_dmv'] = '~r~Tous vos permis ont été suspendue !',
		['no_dmv'] = 'Vous roulez ~g~sans permis ~r~la police est notifié !',
		
		-- Noms des zones
			['AIRP'] = '~g~Los Santos International Airport',
			['ALAMO'] = '~g~Alamo Sea',
			['ALTA'] = '~g~Alta',
			['ARMYB'] = '~g~Fort Zancudo',
			['BANHAMC'] = '~g~Banham Canyon Dr',
			['BANNING'] = '~g~Banning',
			['BEACH'] = '~g~Vespucci Beach',
			['BHAMCA'] = '~g~Banham Canyon',
			['BRADP'] = '~g~Braddock Pass',
			['BRADT'] = '~g~Braddock Tunnel',
			['BURTON'] = '~g~Burton',
			['CALAFB'] = '~g~Calafia Bridge',
			['CANNY'] = '~g~Raton Canyon',
			['CCREAK'] = '~g~Cassidy Creek',
			['CHAMH'] = '~g~Chamberlain Hills',
			['CHIL'] = '~g~Vinewood Hills',
			['CHU'] = '~g~Chumash',
			['CMSW'] = '~g~Chiliad Mountain State Wilderness',
			['CYPRE'] = '~g~Cypress Flats',
			['DAVIS'] = '~g~Davis',
			['DELBE'] = '~g~Del Perro Beach',
			['DELPE'] = '~g~Del Perro',
			['DELSOL'] = '~g~La Puerta',
			['DESRT'] = '~g~Grand Senora Desert',
			['DOWNT'] = '~g~Downtown',
			['DTVINE'] = '~g~Downtown Vinewood',
			['EAST_V'] = '~g~East Vinewood',
			['EBURO'] = '~g~El Burro Heights',
			['ELGORL'] = '~g~El Gordo Lighthouse',
			['ELYSIAN'] = '~g~Elysian Island',
			['GALFISH'] = '~g~Galilee',
			['GOLF'] = '~g~GWC and Golfing Society',
			['GRAPES'] = '~g~Grapeseed',
			['GREATC'] = '~g~Great Chaparral',
			['HARMO'] = '~g~Harmony',
			['HAWICK'] = '~g~Hawick',
			['HORS'] = '~g~Vinewood Racetrack',
			['HUMLAB'] = '~g~Humane Labs and Research',
			['JAIL'] = '~g~Bolingbroke Penitentiary',
			['KOREAT'] = '~g~Little Seoul',
			['LACT'] = '~g~Land Act Reservoir',
			['LAGO'] = '~g~Lago Zancudo',
			['LDAM'] = '~g~Land Act Dam',
			['LEGSQU'] = '~g~ Legion Square',
			['LMESA'] = '~g~La Mesa',
			['LOSPUER'] = '~g~La Puerta',
			['MIRR'] = '~g~Mirror Park',
			['MORN'] = '~g~Morningwood',
			['MOVIE'] = '~g~Richards Majestic',
			['MTCHIL'] = '~g~Mount Chiliad',
			['MTGORDO'] = '~g~Mount Gordo',
			['MTJOSE'] = '~g~Mount Josiah',
			['MURRI'] = '~g~Murrieta Heights',
			['NCHU'] = '~g~North Chumash',
			['NOOSE'] = '~g~N.O.O.S.E',
			['OCEANA'] = '~g~Pacific Ocean',
			['PALCOV'] = '~g~Paleto Cove',
			['PALETO'] = '~g~Paleto Bay',
			['PALFOR'] = '~g~Paleto Forest',
			['PALHIGH'] = '~g~Palomino Highlands',
			['PALMPOW'] = '~g~Palmer-Taylor Power Station',
			['PBLUFF'] = '~g~Pacific Bluffs',
			['PBOX'] = '~g~Pillbox Hill',
			['PROCOB'] = '~g~Procopio Beach',
			['RANCHO'] = '~g~Rancho',
			['RGLEN'] = '~g~Richman Glen',
			['RICHM'] = '~g~Richman',
			['ROCKF'] = '~g~Rockford Hills',
			['RTRAK'] = '~g~Redwood Lights Track',
			['SANAND'] = '~g~San Andreas',
			['SANCHIA'] = '~g~San Chianski Mountain Range',
			['SANDY'] = '~g~Sandy Shores',
			['SKID'] = '~g~Mission Row',
			['SLAB'] = '~g~Stab City',
			['STAD'] = '~g~Maze Bank Arena',
			['STRAW'] = '~g~Strawberry',
			['TATAMO'] = '~g~Tataviam Mountains',
			['TERMINA'] = '~g~Terminal',
			['TEXTI'] = '~g~Textile City',
			['TONGVAH'] = '~g~Tongva Hills',
			['TONGVAV'] = '~g~Tongva Valley',
			['VCANA'] = '~g~Vespucci Canals',
			['VESP'] = '~g~Vespucci',
			['VINE'] = '~g~Vinewood',
			['WINDF'] = '~g~Ron Alternates Wind Farm',
			['WVINE'] = '~g~West Vinewood',
			['ZANCUDO'] = '~g~Zancudo River',
			['ZP_ORT'] = '~g~Port of South Los Santos',
			['ZQ_UAR'] = '~g~Davis Quartz',
