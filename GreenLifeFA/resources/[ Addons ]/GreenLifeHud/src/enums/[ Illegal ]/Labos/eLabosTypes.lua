    ...
    ['procces'] = {
        ...
        ['placePot'] = {
            ...
            action = function(sizePlot, indexPlot, indexPot)
                ...
                TriggerServerEvent('GreenLife:Labo:Weed:PlaceGrassOnPot', sizePlot, indexPlot, indexPot)
            end
        },
        ['potGraas'] = {
            ...
            action = function(sizePlot, indexPlot, indexPot)
                MOD_Weed:OnSelectSeedReady(function(seedVariety)
                    ...
                    TriggerServerEvent('GreenLife:Labo:Weed:PlaceSeedOnPot', sizePlot, indexPlot, indexPot, seedVariety)
                end)
            end
        },
        ['potInGrow'] = {
            ...
            action = function(sizePlot, indexPlot, indexPot)
                TriggerEvent('GreenLife:Labos:Weed:OpenManagePlant', sizePlot, indexPlot, indexPot)
            end
        },
        ['potRecolt'] = {
            state = "potRecolt",
            ...
            action = function(sizePlot, indexPlot, indexPot)
                ...
                TriggerServerEvent('GreenLife:Labos:Weed:RecoltWeedOnPot', sizePlot, indexPlot, indexPot)
            end
        }
    },
