...
RegisterNetEvent('GreenLife:Inventory:WeaponSet')
AddEventHandler('GreenLife:Inventory:WeaponSet', function(data)
    CurrentWeapon = data
end)
...
CreateThread(function()
    while true do
        ...
        for id,ammo in pairs(QueueSaveAmmo) do
            ...
            TriggerServerEvent('GreenLife:Inventory:RemoveWeaponAmmo', id, ammo)
