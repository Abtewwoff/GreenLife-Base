RegisterNetEvent('GreenLife:Inventory:OpenSecondInventory')
AddEventHandler('GreenLife:Inventory:OpenSecondInventory', function(type, InvId, xPly)
    ...
    if (xPlayer.get('SecondInvData') == nil or next(xPlayer.get('SecondInvData')) == nil) then
        ...
        TriggerClientEvent('GreenLife:Inventory:OpenPlayerInventory', xPlayer.source)
    end
end)