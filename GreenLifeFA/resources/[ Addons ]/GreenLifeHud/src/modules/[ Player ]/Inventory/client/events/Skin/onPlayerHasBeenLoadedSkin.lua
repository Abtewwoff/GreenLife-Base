AddEventHandler('GreenLife:PlayerHasBeenLoadedSkin', function()

    if (MOD_inventory.class.inventoryClothes["clothes_tenue"]) then
        TriggerEvent('GreenLife:Inventory:InvSkinClothesChange', MOD_inventory.class.inventoryClothes["clothes_tenue"].args, false)
    end
    ...
    for clotheName, data in pairs(clothesList) do
        if (MOD_inventory.class.inventoryClothes[clotheName] ~= nil) then
            TriggerEvent('GreenLife:Inventory:InvSkinClothesChange', MOD_inventory.class.inventoryClothes[clotheName].args, false, false)
        else
            TriggerEvent('GreenLife:Inventory:InvSkinClothesChange', data, true, false)
        end
    end
