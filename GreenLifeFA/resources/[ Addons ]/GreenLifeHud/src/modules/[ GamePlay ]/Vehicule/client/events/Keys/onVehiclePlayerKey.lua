...
local function changeLockStatus(vehicle)
    ...
    if (locked == 1 or locked == 0) then
        ...
        TriggerServerEvent('GreenLife:Keys:LockVehicle', GetVehicleNumberPlateText(vehicle))
    ...
    elseif (locked == 2) then
        ...
        TriggerServerEvent('GreenLife:Keys:UnlockVehicle', GetVehicleNumberPlateText(vehicle))
...
RegisterNetEvent('GreenLife:Keys:VehiclePlayerKey')
AddEventHandler('GreenLife:Keys:VehiclePlayerKey', function()
