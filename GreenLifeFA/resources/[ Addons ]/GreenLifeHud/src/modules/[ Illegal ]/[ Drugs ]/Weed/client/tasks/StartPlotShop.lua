...
function MOD_Weed:StartPlotShop(size)
    ...
    local EnumPlotList = GreenLife.enums.Labos.Types['weed']['plotManagement'].PlotList[size]
    ...
    CreateThread(function()
        ...
        while (MOD_Weed.LabData.Data.onPlotShop) do
            ...
            if (IsControlJustPressed(0, 191)) then
                TriggerServerEvent('GreenLife:Labo:Weed:BuyPlot', size, PlotList[IndexSelect].index)
