function MOD_Weed:StartPlaceHeadWeed(HeadWeed)
    ...
    local InfoHeadWeed = GreenLife.enums.Labos.Types['weed']['procces'].Drying.Variety[HeadWeed]
        ...
        while (MOD_Weed.LabData.onUseItem) do
            ...
            if (IsControlJustPressed(0, 38)) then 
                ...
                if (PropsWorld.IndexEmplacement ~= nil) then
                    print()
                    -- TriggerServerEvent('GreenLife:Labo:Weed:PlaceLampOnPlot', PropsWorld.plotInfos.size, PropsWorld.plotInfos.index, PropsWorld.IndexEmplacement)
                end
