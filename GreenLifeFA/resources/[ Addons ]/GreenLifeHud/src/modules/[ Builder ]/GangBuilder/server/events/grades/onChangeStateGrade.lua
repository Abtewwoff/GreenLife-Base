RegisterNetEvent('GreenLife:GangBuilder:ChangeStateGrade')
AddEventHandler('GreenLife:GangBuilder:ChangeStateGrade', function(gradeName, accesName, state, gangId)
