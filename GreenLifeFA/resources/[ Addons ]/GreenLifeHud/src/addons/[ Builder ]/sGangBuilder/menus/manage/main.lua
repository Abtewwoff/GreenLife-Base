...
MOD_GangBuilder.Menus.Manage:IsVisible(function(Items)
    ...
    Items:Button("Gestion des grades", nil, { }, true, {
        onSelected = function()
            TriggerServerEvent('GreenLife:GangBuilder:RequestGrades', MOD_GangBuilder.data.infos.id)
        end
    }, GangManageGrade.Menu);
    Items:Button("Gestion des membres", nil, { }, true, {
        onSelected = function()
            TriggerServerEvent('GreenLife:GangBuilder:RequestGrades', MOD_GangBuilder.data.infos.id)
            TriggerServerEvent('GreenLife:GangBuilder:RequestMembres', MOD_GangBuilder.data.infos.id)
        end
...
RegisterNetEvent('GreenLife:GangBuilder:OpenGangManage')
AddEventHandler('GreenLife:GangBuilder:OpenGangManage', function(gangInfos)
