        ...
        Items:Button("Déposer de l'argent", nil, {
            ...
            onSelected = function()
                ...
                if (API_Player:InputIsValid(amount, "number") and tonumber(amount) > 0) then
                    ...
                    if (newAmount > 0) then
                        TriggerServerEvent('GreenLife:Society:AddMoney', MOD_Society.data.name, newAmount, "cash")
                    else
        ...
        Items:Button("Retirer de l'argent", nil, {
            ...
            onSelected = function()
                ...
                if (API_Player:InputIsValid(amount, "number") and tonumber(amount) > 0) then
                    ...
                    if (newAmount > 0) then
                        TriggerServerEvent('GreenLife:Society:RemoveMoney', MOD_Society.data.name, newAmount, "cash")
                    else
                        ESX.ShowNotification("~r~Entré invalide.")
                    end
