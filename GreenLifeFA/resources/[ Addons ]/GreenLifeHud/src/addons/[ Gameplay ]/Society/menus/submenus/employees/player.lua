    ...
    menu.Menu:IsVisible(function(Items)
        ...
        if (employee) then
            ...
            Items:Button("Promouvoir", nil, {}, true, {
                onSelected = function()
                    TriggerServerEvent('GreenLife:Society:SetGrade', MOD_Society.data.name, employee.identifier, "promote")
                    RageUI.GoBack();
                end
            });
            ...
            Items:Button("Rétrograder", nil, {}, true, {
                onSelected = function()
                    TriggerServerEvent('GreenLife:Society:SetGrade', MOD_Society.data.name, employee.identifier, "demote")
                    RageUI.GoBack();
                end
            });
            ...
            Items:Button("Virer", nil, {}, true, {
                onSelected = function()
                    TriggerServerEvent('GreenLife:Society:SetGrade', MOD_Society.data.name, employee.identifier, "fire")
                    RageUI.GoBack();
                end
            });
        else
