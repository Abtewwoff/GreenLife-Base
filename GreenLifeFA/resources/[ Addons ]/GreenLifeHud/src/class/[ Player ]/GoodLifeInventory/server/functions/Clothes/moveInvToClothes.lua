function _GreenLifeInventory:moveInvToClothes(from, to, count)
    to = 'clothes_'..to
    ...
    if (toItem == nil) then
        ...
        TriggerClientEvent('GreenLife:Inventory:InvSkinClothesChange', self.class.source, fromItem.args, false, true, true)
