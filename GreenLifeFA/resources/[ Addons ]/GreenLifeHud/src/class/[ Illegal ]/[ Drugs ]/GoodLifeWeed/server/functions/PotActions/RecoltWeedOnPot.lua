function _GreenLifeDrugWeed:RecoltWeedOnPot(plotSize, plotIndex, potIndex)
    local PotProcces = GreenLife.enums.Labos.Types['weed']['procces']['placePot']
    local VarietyInfo = GreenLife.enums.Labos.Types['weed']['procces'].Variety[self.plotList[plotSize][plotIndex].PotList[potIndex].metadata.variety]
