function _GreenLifeDrugWeed:PlaceSeedOnWeedPot(plotSize, plotIndex, potIndex, seedVariety)
    local PotProcces = GreenLife.enums.Labos.Types['weed']['procces']['potInGrow']
    local VarietySeed = GreenLife.enums.Labos.Types['weed']['procces'].Variety[seedVariety]
