function _GreenLifeDrugWeed:LoadDrugData(plotData)
            ...
            if (self.plotList[size][i] ~= "empty") then
                for _i=1, #self.plotList[size][i].LampList do
                    if (self.plotList[size][i].LampList[_i] ~= "empty") then
                        local LampInfos = GreenLife.enums.Labos.Types['weed']['plotManagement'].PlotList[size][i].LampList[_i]
                ...
                for _i=1, #self.plotList[size][i].PotList do
                    if (self.plotList[size][i].PotList[_i] ~= "empty") then
                        local PotInfos = GreenLife.enums.Labos.Types['weed']['plotManagement'].PlotList[size][i].PotList[_i]
