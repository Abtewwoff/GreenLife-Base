function _GreenLifeDrugWeed:PlaceGrassOnWeedPot(plotSize, plotIndex, potIndex)
    local PotProcces = GreenLife.enums.Labos.Types['weed']['procces']['potGraas']
    ...
    if (self.plotList[plotSize][plotIndex] ~= "empty") then
        ...
        print("Place Grass", json.encode(self.plotList[plotSize][plotIndex].PotList[potIndex]))
    end
