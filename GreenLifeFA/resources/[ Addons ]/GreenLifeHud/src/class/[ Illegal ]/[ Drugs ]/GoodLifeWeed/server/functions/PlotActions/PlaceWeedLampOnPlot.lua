function _GreenLifeDrugWeed:PlaceWeedLampOnPlot(plotSize, plotIndex, potIndex)
    if (self.plotList[plotSize][plotIndex] ~= "empty") then
        local LampObject = GreenLife.enums.Labos.Types['weed']['plotManagement'].PlotList[plotSize][plotIndex].LampObject
        local LampInfos = GreenLife.enums.Labos.Types['weed']['plotManagement'].PlotList[plotSize][plotIndex].LampList[potIndex]
